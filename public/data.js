window.ICU_MANUAL_DB = {
  "app": {
    "name": "ICU AI 업무 매뉴얼",
    "version": "1.74.0-v74-icu-disease-system-summary",
    "language": "ko",
    "source": "V62 동영상 링크 + V63 삭제 + V64 통증이미지분리 + V65 신규자료 + V66 로그인수정 + V67 아그라스타트 + V68 헤파린 + V69 뇌졸중 + V70 심전도 + V71 EVD/ICP/CVP + V72 ABGA + V73 수혈 + V74 중환자실 질병 계통별 총정리",
