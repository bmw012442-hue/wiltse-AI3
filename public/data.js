window.ICU_MANUAL_DB = {
  "app": {
    "name": "ICU AI 업무 매뉴얼",
    "version": "1.54.0-v54-results-table-image-visible",
    "language": "ko",
  ...
  "items": [
    ...
    },
    {
      ...
      "indications": [
        "원내 부서 연락처, 내선번호, 주요 번호를 확인해야 할 때",
        "지참약 식별의뢰, 마약장, DNR 서류 관련 연락처를 확인할 때"
      ],
      "preparation": [],
      "steps": [
        "지참약 식별의뢰서 관련 번호: 6211, 6212",
        "마약장 번호: 6029",
        "DNR 서류 관련 사회복지사: 139번",
      ...
      "io": [],
      "warnings": [
        "원내 내선번호는 변경될 수 있으므로 병원 최신 연락망 확인이 필요합니다."
      ],
      "related": [],
      "tags": [
        "원내정보/전화번호",
